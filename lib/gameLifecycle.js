import { AUTO_SUBMIT_DELAY_MS, COUNTDOWN_START, RESULTS_GRACE_MS } from './constants.js';
import { clearRoomTimers, computeResults, ensureHostPlayer, sanitizePoints } from './roomUtils.js';
...
export class GameLifecycle {
  ...
  recordSubmission(roomId, socketId, points) {
    const room = roomStore.get(roomId);
    if (!room || room.status !== 'running') return { ok: false, error: 'Not accepting submissions' };
